...
use Foosio\BlogBundle\Entity\Blog;
use Foosio\BlogBundle\Form\BlogType;
...
//        $entities = $em->getRepository('FoosioBlogBundle:Blog')->findAll();
        $entities = [1,2,3,4,4,5,6,3,23,23];
        $res = new JsonResponse();
        return $res->setData($entities);
//        return array(
//            'entities' => $entities,
//        );
    }
...
//     * @Method("POST")
//     * @Template("FoosioBlogBundle:Blog:new.html.twig")
//     */
...
//        $em = $this->getDoctrine()->getManager();
//
//        $entity = $em->getRepository('FoosioBlogBundle:Blog')->find($id);
//
//        if (!$entity) {
...
//     * @Method("PUT")
//     * @Template("FoosioBlogBundle:Blog:edit.html.twig")
//     */
